...
//    protected LinkedHashMap<String, String> valuesFromUser;
     ...
     */
    public HashMap<String, Object> delete(int id) throws SQLException{
        HashMap<String, Object> item = get(id);
     ...
     */
    public HashMap<String, Object> get(int id) throws SQLException{
     ...
     */
    public ArrayList<HashMap<String, Object>> getAll() throws SQLException{
    ...
    private ArrayList<HashMap<String, Object>> readAllQuerey(ResultSet rs) throws SQLException{
    ...
    @Override
    public PreparedStatement putInsertValuesToParams(PreparedStatement p, HashMap<String, String> data) throws SQLException {
        int i = 1;
    ...
    @Override
    public int putUpdateValuesToParams(PreparedStatement p, HashMap<String, String> data) throws SQLException {
        int i = 1;
