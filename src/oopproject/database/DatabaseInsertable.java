...
//    HashMap<String, String> getValues();
     ...
     * @return 
     */
    PreparedStatement putInsertValuesToParams(PreparedStatement p, HashMap<String, String> data) throws SQLException;
    
    
    int putUpdateValuesToParams(PreparedStatement p, HashMap<String, String> data) throws SQLException;
}
